...
import type { BetterAuthPlugin, Prettify } from "better-auth/types";
      ...
      organization: {
        ...
        fields: {
          ...
          createdAt: {
            ...
            required: true,
            fieldName:
              options?.schema?.organization?.fields?.createdAt ?? "created",
          },
          metadata: {
            type: "string",
            required: false,
      ...
      member: {
        ...
        fields: {
          organizationId: {
            ...
            fieldName:
              options?.schema?.member?.fields?.organizationId ?? "tenant_id",
          },
          userId: {
            type: "string",
            required: true,
